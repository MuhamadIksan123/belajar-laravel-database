...
class QueryBuilderTest extends TestCase
{
    ...
    public function testWhereNotBeetwen()
    {
        $this->insertCategories();

        $collection = DB::table("categories")
        ->whereNotBetween('created_at', ["2020-09-10 10:10:10", "2020-11-10 10:10:10"])->get();
    ...
    public function testWhereNotIn()
    {
        ...
        $collection = DB::table("categories")->whereNotIn("id", ["SMARTPHONE", "LAPTOP"])->get();
    ...
    public function testUpSert()
    {
        DB::table('categories')->updateOrInsert([
            ...
            "name" => "Voucher",
            "description" => "Voucher and Ticket",
            "created_at" => "2020-10-10 10:10:10"
        ]);
   ...
   public function insertProducts()
    ...
    public function testQueryBuilderRawa()
    {
        $this->insertProducts();
    ...
    public function testGroupingBy()
    {
        $this->insertProducts();
    ...
    public function testGroupingByHaving()
    {
        $this->insertProducts();
        $this->insertProductsFood();
