...
class TransactionTest extends TestCase
{
    ...
    public function testTransaction()
    {
        DB::transaction(function(){
             ...
             DB::insert('insert into categories(id, name, description, created_at) values (?, ?, ?, ?)', ["FOOD", "Food", "Food Category", "2020-10-10 10:10:10"]);
        });
    ...
    public function testTransactionFailed()
    {
        try {
            DB::transaction(function(){
                ...
                DB::insert('insert into categories(id, name, description, created_at) values (?, ?, ?, ?)', ["GADGET", "Food", "Food Category", "2020-10-10 10:10:10"]);
            });
